...
export default function Settings() {
	...
	return (
		<div className="container text-center text-md-start d-flex flex-column min-vh-100 py-4">
			<div className="mb-4">
				<h1>Settings</h1>
				<hr className="border border-primary mt-0" />
			</div>

			<div className="card border border-primary w-75 align-self-center">
				<div className="card-body">
					{/* Theme */}
					<div className="mb-4 row px-md-5 align-items-center">
					...
					{/* Language */}
					<div className="mb-3 px-md-5 row align-items-center">
						<div className="col-md-6 col-sm-12">
